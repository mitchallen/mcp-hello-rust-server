...
[![ci](https://github.com/mitchallen/mcp-hello-rust-server/actions/workflows/ci.yml/badge.svg)](https://github.com/mitchallen/mcp-hello-rust-server/actions/workflows/ci.yml) [![image-scan](https://github.com/mitchallen/mcp-hello-rust-server/actions/workflows/image-scan.yml/badge.svg)](https://github.com/mitchallen/mcp-hello-rust-server/actions/workflows/image-scan.yml) [![cargo-audit](https://github.com/mitchallen/mcp-hello-rust-server/actions/workflows/cargo-audit.yml/badge.svg)](https://github.com/mitchallen/mcp-hello-rust-server/actions/workflows/cargo-audit.yml) [![publish](https://github.com/mitchallen/mcp-hello-rust-server/actions/workflows/publish.yml/badge.svg)](https://github.com/mitchallen/mcp-hello-rust-server/actions/workflows/publish.yml)

[![Docker Hub](https://img.shields.io/docker/v/mitchallen/mcp-hello-rust-server?sort=semver&logo=docker&label=Docker%20Hub)](https://hub.docker.com/r/mitchallen/mcp-hello-rust-server) [![Docker pulls](https://img.shields.io/docker/pulls/mitchallen/mcp-hello-rust-server?logo=docker)](https://hub.docker.com/r/mitchallen/mcp-hello-rust-server) [![Image size](https://img.shields.io/docker/image-size/mitchallen/mcp-hello-rust-server?sort=semver&logo=docker)](https://hub.docker.com/r/mitchallen/mcp-hello-rust-server) [![GHCR](https://img.shields.io/badge/GHCR-mcp--hello--rust--server-2088FF?logo=github)](https://github.com/mitchallen/mcp-hello-rust-server/pkgs/container/mcp-hello-rust-server) [![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)
